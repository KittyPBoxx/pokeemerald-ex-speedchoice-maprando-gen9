...
const struct StaticPokemon gStaticPokemon[][8] = {
    ...
    {{"RustboroCity_DevonCorp_2F_EventScript_ArctozoltReady", 0x2}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveArctozolt", 0x3}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveArctozolt", 0xC}},
    {{"RustboroCity_DevonCorp_2F_EventScript_ArctovishReady", 0x2}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveArctovish", 0x3}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveArctovish", 0xC}},
    {{"RustboroCity_DevonCorp_2F_EventScript_DracovishReady", 0x2}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveDracovish", 0x3}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveDracovish", 0xC}},
    {{"RustboroCity_DevonCorp_2F_EventScript_DracozoltReady", 0x2}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveDracozolt", 0x3}, {"RustboroCity_DevonCorp_2F_EventScript_ReceiveDracozolt", 0xC}},
    ...
    {{"DesertRuins_EventScript_Regirock", 0x2}, {"DesertRuins_EventScript_Regirock", 0x8}, {"DesertRuins_EventScript_Regirock_Battle", 0x1}, {"DesertRuins_EventScript_RanFromRegirock", 0x3}},
    {{"IslandCave_EventScript_Regice", 0x2}, {"IslandCave_EventScript_Regice", 0x8}, {"IslandCave_EventScript_Regice_Battle", 0x1}, {"IslandCave_EventScript_RanFromRegice", 0x3}},
    {{"AncientTomb_EventScript_Registeel", 0x2}, {"AncientTomb_EventScript_Registeel", 0x8}, {"AncientTomb_EventScript_Registeel_Battle", 0x1}, {"AncientTomb_EventScript_RanFromRegisteel", 0x3}},
