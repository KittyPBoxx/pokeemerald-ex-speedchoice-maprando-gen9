...
const u8 gText_CantTossImportantItems[] = _("Important items\ncan't be tossed!");
const u8 gText_CantTossRegisteredItems[] = _("Registered items\ncan't be tossed!");
...
const u8 gText_RepelCaseRunOut[] = _("You have no REPELS left{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a {STR_VAR_2}, too.{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBalls[] = _("I'll throw in {STR_VAR_1} {STR_VAR_2}s, too.{PAUSE_UNTIL_PRESS}");
