...
static const u16 gExpansionMusicTracks[] = 
{
    ...
    MUS_BW_ANVILLE                    ,
    MUS_BW_LACUNOSA                   ,
    MUS_BW_UNDELLA_SUMMER             ,
    MUS_BW_UNDELLA_WINTER             ,
    MUS_BW_STRIATON                   ,
    MUS_BW_NACRENE                    ,
    MUS_BW_CASTELIA                   ,
    MUS_BW_NIMBASA                    ,
    ...
    MUS_BW_MISTRALTON                 ,
    MUS_BW_ICIRRUS                    ,
    MUS_BW_OPELUCID_WHITE             ,
    MUS_BW_BLACK_CITY                 ,
    MUS_BW_WHITE_FOREST               ,
    MUS_BW_ROUTE1                     ,
    MUS_BW_ROUTE4_SUMMER              ,
    MUS_BW_ROUTE6_SUMMER              ,
    MUS_BW_ROUTE10                    ,
    MUS_BW_TUBELINE_BRIDGE            ,
    MUS_BW_POKE_CENTER                ,
    MUS_BW_SHOPPING_MALL_NINE         ,
    MUS_BW_GYM                        ,
    MUS_BW_ENTRALINK                  ,
    MUS_BW_POKEMON_LEAGUE             ,
    MUS_BW_N_CASTLE                   ,
    MUS_BW_DREAMYARD                  ,
    MUS_BW_CHARGESTONE_CAVE           ,
    MUS_BW_DRAGONSPIRAL_TOWER         ,
    MUS_BW_BIANCA                     ,
    MUS_BW_EMOTION                    ,
    MUS_BW_TROUBLE                    ,
    MUS_BW_FAREWELL                   ,
    ...
    MUS_BW_LOW_HEALTH                 ,
    MUS_BW_GTS                        ,
    MUS_B2_ROUTE19_SUMMER             ,
    MUS_B2_FLOCCESY                   ,
    MUS_B2_PLASMA_FRIGATE_1           ,
    MUS_XY_BOUTIQUE                   ,
    MUS_XY_BICYCLE                    ,
    MUS_ORAS_SOARING_DREAMS           ,
    MUS_SM_HAUOLI                     ,
    MUS_COL_MIROR_B_BATTLE            ,
    MUS_MD_RAGGED_MOUNTAIN            ,
    MUS_MD_DONT_EVER_FORGET           ,
    MUS_RAN_LYRA_FOREST               ,
};
