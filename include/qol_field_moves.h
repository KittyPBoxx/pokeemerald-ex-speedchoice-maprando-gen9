...
u32 UseStrength(u32, s16, s16, u8);
...
// Cut and Rocksmash are super broken with bikes. Either side hopping on an acro or ending mach movement with a turn and bonk. Surf is also broken with acro but not badly
#define QOL_NO_MESSAGING_SURF
#define QOL_NO_MESSAGING_STRENGTH
#define QOL_NO_MESSAGING_WATERFALL