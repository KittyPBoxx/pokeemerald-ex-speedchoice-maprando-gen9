...
#define B_WAIT_TIME_LONG        (4 * B_WAIT_TIME_MULTIPLIER)
#define B_WAIT_TIME_MED         (3 * B_WAIT_TIME_MULTIPLIER)
#define B_WAIT_TIME_SHORT       (2 * B_WAIT_TIME_MULTIPLIER)
#define B_WAIT_TIME_SHORTEST    (1 * B_WAIT_TIME_MULTIPLIER)
