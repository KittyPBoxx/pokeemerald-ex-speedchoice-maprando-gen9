...
#define FLAG_ALWAYS_OBEY       0x273
#define FLAG_SUMMARY_RELEARNER 0x274 
#define FLAG_USE_DMAX          0x275
#define FLAG_MODERN_EXP_SHARE  0x276
#define FLAG_HEAL_AFTER_BATTLE 0x277
#define FLAG_SUMMARY_FIRST     0x278
...
#define FLAG_SYS_USE_SURF                           (SYSTEM_FLAGS + 0x26)
...
#define FLAG_DISABLE_FOLLOWER                       (SYSTEM_FLAGS + 0x83)

#define FLAG_RECEIVED_POKEDEX_FROM_BIRCH            (SYSTEM_FLAGS + 0x84)

#define FLAG_VISITED_ROUTE_101                      (SYSTEM_FLAGS + 0x85)
#define FLAG_VISITED_ROUTE_102                      (SYSTEM_FLAGS + 0x86)
#define FLAG_VISITED_ROUTE_103                      (SYSTEM_FLAGS + 0x87)
#define FLAG_VISITED_ROUTE_104                      (SYSTEM_FLAGS + 0x88)
#define FLAG_VISITED_ROUTE_105                      (SYSTEM_FLAGS + 0x89)
#define FLAG_VISITED_ROUTE_106                      (SYSTEM_FLAGS + 0x8A)
#define FLAG_VISITED_ROUTE_107                      (SYSTEM_FLAGS + 0x8B)
#define FLAG_VISITED_ROUTE_108                      (SYSTEM_FLAGS + 0x8C)
#define FLAG_VISITED_ROUTE_109                      (SYSTEM_FLAGS + 0x8D)
#define FLAG_VISITED_ROUTE_110                      (SYSTEM_FLAGS + 0x8E)
#define FLAG_VISITED_ROUTE_111                      (SYSTEM_FLAGS + 0x8F)
#define FLAG_VISITED_ROUTE_112                      (SYSTEM_FLAGS + 0x90)
#define FLAG_VISITED_ROUTE_113                      (SYSTEM_FLAGS + 0x91)
#define FLAG_VISITED_ROUTE_114                      (SYSTEM_FLAGS + 0x92)
#define FLAG_VISITED_ROUTE_115                      (SYSTEM_FLAGS + 0x93)
#define FLAG_VISITED_ROUTE_116                      (SYSTEM_FLAGS + 0x94)
#define FLAG_VISITED_ROUTE_117                      (SYSTEM_FLAGS + 0x95)
#define FLAG_VISITED_ROUTE_118                      (SYSTEM_FLAGS + 0x96)
#define FLAG_VISITED_ROUTE_119                      (SYSTEM_FLAGS + 0x97)
#define FLAG_VISITED_ROUTE_120                      (SYSTEM_FLAGS + 0x98)
#define FLAG_VISITED_ROUTE_121                      (SYSTEM_FLAGS + 0x99)
#define FLAG_VISITED_ROUTE_122                      (SYSTEM_FLAGS + 0x9A)
#define FLAG_VISITED_ROUTE_123                      (SYSTEM_FLAGS + 0x9B)
#define FLAG_VISITED_ROUTE_124                      (SYSTEM_FLAGS + 0x9C)
#define FLAG_VISITED_ROUTE_125                      (SYSTEM_FLAGS + 0x9D)
#define FLAG_VISITED_ROUTE_126                      (SYSTEM_FLAGS + 0x9E)
#define FLAG_VISITED_ROUTE_127                      (SYSTEM_FLAGS + 0x9F)
#define FLAG_VISITED_ROUTE_128                      (SYSTEM_FLAGS + 0xA0)
#define FLAG_VISITED_ROUTE_129                      (SYSTEM_FLAGS + 0xA1)
#define FLAG_VISITED_ROUTE_130                      (SYSTEM_FLAGS + 0xA2)
#define FLAG_VISITED_ROUTE_131                      (SYSTEM_FLAGS + 0xA3)
#define FLAG_VISITED_ROUTE_132                      (SYSTEM_FLAGS + 0xA4)
#define FLAG_VISITED_ROUTE_133                      (SYSTEM_FLAGS + 0xA5)
#define FLAG_VISITED_ROUTE_134                      (SYSTEM_FLAGS + 0xA6)
